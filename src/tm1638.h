...
/**
 * Muestra un número (0-9) en un display de 7 segmentos específico.
 *
 * digit_pos: 0-7 (0 = dígito más a la izquierda, 7 = más a la derecha).
 *            Fuera de rango -> -EINVAL.
 * number: 0-9. Fuera de rango -> -EINVAL.
 */
int tm1638_set_number(int digit_pos, int number);
